...
/*   const int64_t  min_pervote_daily_pay = 100'0000;
   ...
   //DAPP  
   //const double dapp_dev_pay = .005;  //0.5%
   //Vote_pay 
   //const double user_pay = 00.00125; //  0.125%
   ...
   void system_contract::claimrewards( const name owner ) {
      ...
      print("what is the owner value, " , owner);
      check( _gstate.total_activated_stake >= min_activated_stake,
                    "cannot claim rewards until the chain is activated (at least 15% of all tokens participate in voting)" );
      print("what is the total_activated_stake, " , _gstate.total_activated_stake);
      print("what is the min_activated_stake, " ,  min_activated_stake);
     ...
     // check( ct - prod.last_claim_time > microseconds(useconds_per_day), "already claimed rewards within past day" );
      ...
      print("what is the total suypply, " , token_supply);
      print("what is the token_amount, " ,  token_account);
